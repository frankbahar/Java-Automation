...
public class Homework25 {
	/*
	 * Math Magic In this project, you will become a magician and write a small
	 ...
	 * To Do:
	 * 
	 * Create a java program and name it "Main".
	 * 
	 * Create an int variable called myNumber. Set it equal to any integer other
	 * than 0. We will refer to myNumber as the original number from now on. Create
	 * an int variable called stepOne. Set it equal to the original number
	 * (myNumber) multiplied by itself. Create an int variable called stepTwo. Set
	 * it equal to the previous result (stepOne) plus the original number
	 * (myNumber). Create an int variable called stepThree. Set it equal to the
	 * previous result (stepTwo) divided by the original number. Create an int
